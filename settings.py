...
class Settings:
    ...
    'lime', 'coconut', 'avocado', 'fig', 'passion', 'guava', 'pomegranate', 'dragonfruit', 'melon', 'kiwi',
    'starfruit', 'lychee', 'tangerine', 'grapefruit', 'persimmon', 'jackfruit', 'date', 'nectarine', 'apricot', 'quince',
    'blackcurrant', 'boysenberry', 'gooseberry', 'kiwano', 'mangosteen', 'mulberry', 'olive', 'pawpaw', 'pricklypear',
    'rhubarb', 'carrot', 'potato', 'tomato', 'broccoli', 'cabbage', 'cauliflower', 'spinach', 'onion', 'garlic', 'pepper',
    'lettuce', 'cucumber', 'zucchini', 'eggplant', 'greenbean', 'pea', 'corn', 'radish', 'beetroot', 'asparagus',
    'celery', 'leek', 'sweetpotato', 'pumpkin', 'squash', 'artichoke', 'brusselssprout', 'kale', 'okra', 'mushroom',
    'turnip', 'yam', 'cassava', 'fennel', 'bambooshoot', 'rhubarb', 'endive', 'bokchoy', 'parsnip', 'ginger', 'horseradish',
    ...
    'horse', 'sheep', 'goat', 'pig', 'rabbit', 'squirrel', 'hamster', 'mouse', 'rat', 'guineapig',
